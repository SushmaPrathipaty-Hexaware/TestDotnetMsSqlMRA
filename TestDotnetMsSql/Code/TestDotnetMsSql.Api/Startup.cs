using TestDotnetMsSql.Api.Installer;
using TestDotnetMsSql.Api.Middleware;
using TestDotnetMsSql.Data.Repositories;
...
using System;
using TestDotnetMsSql.Api.Opentelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace TestDotnetMsSql.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestDotnetMsSql V1");
        });
