...
using TestDotnetMsSql.Api.Filters;
using TestDotnetMsSql.Business.Installer;

namespace TestDotnetMsSql.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "TestDotnetMsSql API", Version = version + "-" + branch });
        });
